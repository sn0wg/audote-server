...
{
    public class GetAnimalsHandler : IRequestHandler<GetAnimalsQuery, Animal[]>
    {
        ...
        public Task<Animal[]> Handle(GetAnimalsQuery request, CancellationToken cancellationToken)
        {
